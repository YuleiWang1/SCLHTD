...
def plot_roc_curve(y, pred, title):
    ...
    plt.savefig('result/'+title+ 'ROC' +'.png', bbox_inches= 'tight', pad_inches = 0, dpi = 1000)
    plt.show()
...
def loadData(name):
    ...
    if name == 'Sandiego2':
        ...
        # agumentation_one = sio.loadmat(os.path.join(data_path, 'Sandiego2', 'AAE_Features1.mat'))['AAE_Features1']
        # agumentation_two = sio.loadmat(os.path.join(data_path, 'Sandiego2', 'AAE_Features2.mat'))['AAE_Features2']
        agumentation_one = sio.loadmat(os.path.join(data_path, 'Sandiego2', 'agumentation_one.mat'))['agumentation_one']
        agumentation_two = sio.loadmat(os.path.join(data_path, 'Sandiego2', 'agumentation_two.mat'))['agumentation_two']
        ...
        agumentation_one = sio.loadmat(os.path.join(data_path, 'Sandiego100', 'agumentation_one.mat'))['agumentation_one']
        agumentation_two = sio.loadmat(os.path.join(data_path, 'Sandiego100', 'agumentation_two.mat'))['agumentation_two']
    elif name == 'MUUFL':
        data = sio.loadmat(os.path.join(data_path, 'MUUFL', 'data.mat'))['data']
        labels = sio.loadmat(os.path.join(data_path, 'MUUFL', 'y1.mat'))['y1']
        # agumentation_one = sio.loadmat(os.path.join(data_path, 'MUUFL', 'AAE_Features1.mat'))['AAE_Features1']
        # agumentation_two = sio.loadmat(os.path.join(data_path, 'MUUFL', 'AAE_Features2.mat'))['AAE_Features2']
        agumentation_one = sio.loadmat(os.path.join(data_path, 'MUUFL', 'agumentation_one.mat'))['agumentation_one']
        agumentation_two = sio.loadmat(os.path.join(data_path, 'MUUFL', 'agumentation_two.mat'))['agumentation_two']
    elif name == 'GF5':
        data = sio.loadmat(os.path.join(data_path, 'GF5', 'data.mat'))['data']
        labels = sio.loadmat(os.path.join(data_path, 'GF5', 'y1.mat'))['y1']
        agumentation_one = sio.loadmat(os.path.join(data_path, 'GF5', 'AAE_Features1.mat'))['AAE_Features1']
        agumentation_two = sio.loadmat(os.path.join(data_path, 'GF5', 'AAE_Features2.mat'))['AAE_Features2']
    elif name == 'Sandiego':
        ...
        agumentation_one = sio.loadmat(os.path.join(data_path, 'Urban1', 'agumentation_one.mat'))['agumentation_one']
        agumentation_two = sio.loadmat(os.path.join(data_path, 'Urban1', 'agumentation_two.mat'))['agumentation_two']
    elif name == 'Urban2':
